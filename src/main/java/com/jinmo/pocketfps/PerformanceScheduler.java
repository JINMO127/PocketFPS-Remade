...
public class PerformanceScheduler {
    ...
    private static void applyLevel(OptimizationLevel level, float fps) {
        ...
        switch (level) {
            case LIGHT:
                ...
                com.jinmo.pocketfps.lod.mixin.RedstoneLimiterMixin.setMaxDistance(64);
                PerformanceTuner.LOGGER.info(String.format("🟢 轻度优化 (FPS: %.1f)", fps));
                break;
            ...
            case MEDIUM:
                ...
                com.jinmo.pocketfps.lod.mixin.RedstoneLimiterMixin.setMaxDistance(32);
                com.jinmo.pocketfps.lod.mixin.ChunkUpdateThrottlerMixin.setThrottleRate(3);
                PerformanceTuner.LOGGER.info(String.format("🟡 中度优化 (FPS: %.1f)", fps));
                break;
            ...
            case HEAVY:
                ...
                com.jinmo.pocketfps.lod.mixin.RedstoneLimiterMixin.setMaxDistance(16);
                com.jinmo.pocketfps.lod.mixin.ChunkUpdateThrottlerMixin.setThrottleRate(5);
                FramePredictor.enable(true);
                PerformanceTuner.LOGGER.info(String.format("🔴 重度优化 (FPS: %.1f) - 帧预测已激活", fps));
                break;
    ...
    private static void restoreAll() {
        ...
        com.jinmo.pocketfps.lod.mixin.RedstoneLimiterMixin.setMaxDistance(-1); // 无限制
        com.jinmo.pocketfps.lod.mixin.ChunkUpdateThrottlerMixin.setThrottleRate(1);
